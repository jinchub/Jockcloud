...
const headerUploadWrapper = document.getElementById("headerUploadWrapper");
const headerUploadTrigger = document.getElementById("headerUploadTrigger");
const headerUploadPopover = document.getElementById("headerUploadPopover");
...
const mobileNewFolderPopoverBtn = document.getElementById("mobileNewFolderPopoverBtn");
...
const hiddenSpaceUnlockedIcon = document.getElementById("hiddenSpaceUnlockedIcon");
const hiddenSpaceAutoExitTip = document.getElementById("hiddenSpaceAutoExitTip");
...
const renameSuffixDisplay = document.getElementById("renameSuffixDisplay");
const renameSuffixText = document.getElementById("renameSuffixText");
...
const mobileBottomActions = document.getElementById("mobileBottomActions");
const mobileBatchRestoreBtn = document.getElementById("mobileBatchRestoreBtn");
const mobileBatchOpenBtn = document.getElementById("mobileBatchOpenBtn");
const mobileBatchDetailBtn = document.getElementById("mobileBatchDetailBtn");
const mobileBatchRenameBtn = document.getElementById("mobileBatchRenameBtn");
const mobileBatchPinBtn = document.getElementById("mobileBatchPinBtn");
const mobileBatchDownloadBtn = document.getElementById("mobileBatchDownloadBtn");
const mobileBatchShareBtn = document.getElementById("mobileBatchShareBtn");
const mobileBatchCopyBtn = document.getElementById("mobileBatchCopyBtn");
const mobileBatchMoveBtn = document.getElementById("mobileBatchMoveBtn");
const mobileBatchPasteBtn = document.getElementById("mobileBatchPasteBtn");
...
const profileCenterLastLoginAt = document.getElementById("profileCenterLastLoginAt");
const profileCenterLastLoginIp = document.getElementById("profileCenterLastLoginIp");
...
const PAGE_SIZE_OPTIONS = [0, 20, 50, 100, 150, 200];
